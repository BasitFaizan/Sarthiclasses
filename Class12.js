...
let accordians = document.querySelector('.accordians2');
chapterNameClass12.forEach((items) => {
  accordians.innerHTML += `
    <div class="collapseFlex ${items.classes}">
          ...
          <div class="para">
            <h2>Here you can learn about Class 12 chapter  name as ${items.chaptername}</h2>
